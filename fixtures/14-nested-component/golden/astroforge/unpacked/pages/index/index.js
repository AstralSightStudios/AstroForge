  ...
  (function(global, globalThis, window, $app_exports$, $app_evaluate$) {
    ...
    var createPageHandler = function() {
      return (function() {
        ...
        $app_exports$["contact-card"] = function($component_exports$) {
          ...
          var $app_template$ = function(vm) {
            var _vm_ = vm || this;
            return aiot.__ce__("div", { __vm__: _vm_, __opts__: { events: { click: function(evt) { return _vm_.onCardTap(evt); } } } }, [aiot.__ce__("text", { __vm__: _vm_, __opts__: { value: function() { return _vm_.name; } } }, [])]);
          };
        ...
        var $app_script$ = function __scriptModule__(module, exports, $app_require$) {
          Object.defineProperty(exports, "__esModule", { value: true });
          exports.default = {
          handleCardTap: function handleCardTap(evt) {
            console.log(evt);
          }
        };
          normalizeVmModule(exports.default || module.exports);
        ...
        var $app_template$ = function(vm) {
          var _vm_ = vm || this;
          return aiot.__ce__("div", { __vm__: _vm_, __opts__: {} }, [aiot.__cc__("contact-card", { __vm__: _vm_, __opts__: { name: "Ada", events: { cardtap: function(evt) { return _vm_.handleCardTap(evt); } } } }, [])]);
        };

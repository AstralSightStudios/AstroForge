  ...
  (function(global, globalThis, window, $app_exports$, $app_evaluate$) {
    ...
    var createPageHandler = function() {
      return (function() {
        ...
        var $app_style$ = [
          [[[[0, "card"]], [[1, "primary"]]], { width: "192px", color: "#ffffff" }],
          [[[[2, "text"]]], { fontSize: "24px" }],
          [[[[4, "font-face"]]], { fontFamily: "AstroForgeFixture", src: "url(\"/common/fixture.woff\")" }],
          [[[[3, "pulse"]]], { opacity: "1" }]
        ];
        ...
        var $app_template$ = function(vm) {
          var _vm_ = vm || this;
          return aiot.__ce__("div", { __vm__: _vm_, __opts__: { classList: ["card"] } }, [aiot.__ce__("text", { __vm__: _vm_, __opts__: { value: "Styled" } }, [])]);
        };
